 ...
 * before the shop's, so it wins by registration order alone - and it carries symfony
 * components and, where the optional minifier is installed, voku/simple_html_dom. Whichever of
 * those wins has to be the shop's copy, because that is what the module runs against in
 * production: the OXID 6 line pins symfony 3.4/2.8 components that a module-side copy would
 * shadow.
 */
$moduleAutoloader->unregister();

$testOnlyPrefixes = [
    'foun10\\EasyCache\\Tests\\',
    'PHPUnit\\',
    'SebastianBergmann\\',
    'PharIo\\',
    'DeepCopy\\',
